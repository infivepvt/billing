...
$product = array('Business card Design','Business card Print','Sticker print','Flyer Print','Tag Print','Any Other Design','Any Other Print','Delivery');
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            if( isset($_POST['btnCreateOrder']) )
            {
                ...
                try {
                    ...
                    foreach($products as $product)
                    {
                        ...
                        if($product == 'Business card Print')
                        {
                            if($business_card_print_type == 'Shape' )
                                $business_card_print_type = $business_card_print_txtType[0];
                            if($business_card_print_thikness == 'Other')
                                $business_card_print_thikness = $business_card_print_txtThikness[0];
            
                            $product_info['Type'] = $business_card_print_type;
                            $product_info['Thikness'] = $business_card_print_thikness;
                            
                            $search = 'Other';
                            $key = array_search($search, $business_card_print_print_type);
                            if (!empty($key)) {
                                
                                $business_card_print_print_type[$key] = $business_card_print_txtPrintType[0];
                            }

                            $product_info['Print_Type'] = implode(', ',$business_card_print_print_type);

                            $product_info['Finishes'] = $business_card_print_finishes;
                            $product_info['Corners'] = $business_card_print_corners;
          ...
          <div class="section-body" >
            ...
            <div class="row">
                <div class="col-md-12" style="border: 1px solid black;border-radius:5px;background-color: #FFF;padding-left:50px">
                    ...
                    <!-- BUSINESS CARD PRINT SPECIFICATION START -->
                    <div class="row" id="business_card_print" style="display:none;">
                        <div class="col-md-6" style="border:1px solid black;border-radius: 5px;background-color: white;">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="display:flex;align-items: center;">
                                    <input type="radio" name="business_card_print_type" value="Standard Shape" class="form-control frmRadio">&nbsp; Standard Shape &nbsp;&nbsp;
                                    
                                    <input type="radio" name="business_card_print_type" value="Shape CUT" class="form-control frmRadio">&nbsp; Shape CUT &nbsp;&nbsp;
                                    
                                    <input type="radio" name="business_card_print_type" value="Shape" class="form-control frmRadio">&nbsp;&nbsp; Shape &nbsp;

                                    <input type="text" name="business_card_print_txtType[]" class="form-control" style="width:150px;height:35px;">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12" style="display:flex;align-items: center;">
                                    <input type="radio" name="business_card_print_thikness" value="360gsm" class="form-control frmRadio">&nbsp; 360gsm &nbsp;&nbsp;
                                    
                                    <input type="radio" name="business_card_print_thikness" value="760gsm (32pt)" class="form-control frmRadio">&nbsp; 760gsm (32pt) &nbsp;&nbsp;
                                    
                                    <input type="radio" name="business_card_print_thikness" value="Other" class="form-control frmRadio">&nbsp;&nbsp; Other &nbsp;

                                    <input type="text" name="business_card_print_txtThikness[]" class="form-control" style="width:150px;height:35px;">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12" style="display:flex;align-items: center;">
                                    <input type="checkbox" name="business_card_print_print_type[]" value="Full color" class="form-control frmRadio">&nbsp; Full color &nbsp;&nbsp;
                                    
                                    <input type="checkbox" name="business_card_print_print_type[]" value="Gold Foil" class="form-control frmRadio">&nbsp; Gold Foil &nbsp;&nbsp;

                                    <input type="checkbox" name="business_card_print_print_type[]" value="Silver Foil" class="form-control frmRadio">&nbsp; Silver Foil &nbsp;&nbsp;
                                    
                                    <input type="checkbox" name="business_card_print_print_type[]" value="Other" class="form-control frmRadio">&nbsp;&nbsp; Other &nbsp;

                                    <input type="text" name="business_card_print_txtPrintType[]" class="form-control" style="width:150px;height:35px;">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12" style="display:flex;align-items: center;">
                                    <input type="radio" name="business_card_print_finishes" value="Matte" class="form-control frmRadio">&nbsp; Matte &nbsp;&nbsp;
                                    
                                    <input type="radio" name="business_card_print_finishes" value="Velvet" class="form-control frmRadio">&nbsp; Velvet &nbsp;&nbsp;

                                    <input type="radio" name="business_card_print_finishes" value="Gloss" class="form-control frmRadio">&nbsp; Gloss &nbsp;&nbsp;
                                    
                                    <input type="radio" name="business_card_print_finishes" value="None" class="form-control frmRadio">&nbsp;&nbsp; None &nbsp;
                            ...
                            <div class="row">
                                <div class="col-md-12" style="display:flex;align-items: center;">
                                    <input type="radio" name="business_card_print_corners" value="Square" class="form-control frmRadio">&nbsp; Square &nbsp;&nbsp;
                                    
                                    <input type="radio" name="business_card_print_corners" value="Rounded" class="form-control frmRadio">&nbsp; Rounded &nbsp;&nbsp;
                    ...
                    <!-- BUSINESS CARD PRINT SPECIFICATION END -->
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
      ...
      function get_specification(val)
      {
        ...
        if(val == 'Business card Print')
        {
            $('#div_product_spec_'+product_cnt).html($('#business_card_print').html())  
        }
